...
public class Missing_data extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Missing_data frame = new Missing_data();
	...
	public Missing_data() {
		...
		JLabel lblNewLabel_1 = new JLabel("System Error!");
		...
		btnNewButton.setBounds(332, 146, 147, 33);
		Success.add(btnNewButton);
		
		JLabel lblNewLabel_2 = new JLabel("there are missing data!");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 20));
		lblNewLabel_2.setBounds(300, 91, 265, 44);
